    ...
    <>
      ...
      >
        ...
        <SwissContainer className="relative z-10 flex flex-col items-center text-center">
          ...
          <div className="not-found-content max-w-2xl mx-auto">
            ...
            <p className="text-white/60 text-base md:text-lg mb-12 leading-relaxed">
              El recurso solicitado no ha sido localizado en el servidor. Es
              posible que el enlace esté roto o que el archivo haya sido
              reubicado permanentemente.
            </p>
        ...
        <div className="mt-auto pt-20">
          <MarqueeBanner
            text="ERROR 404 • SYSTEM OVERLOAD • LOST IN SPACE • PAGE NOT FOUND •"
            speed={50}
          />
        </div>
